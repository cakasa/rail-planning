...
# python -c "import pddl_generator; pddl_generator.create_problem_file()"
def create_problem_file():
    ...
    """
    filename = "problemgenerated.pddl"
    name = "myproblem"
    arrival_order = ["sng", "sng", "sng", "icm", "icm", "icm", "virm", "virm", "virm", "slt", "slt", "slt"]
    departure_train_units = {
        "sng": [10, 11, 12],
        "icm": [7, 8, 9],
        "virm": [4, 5, 6],
        "slt": [1, 2, 3]
    ...
    tracks = [[1, 2], [3, 4, 5], [11, 12], [13, 14], [15, 16, 17]]
