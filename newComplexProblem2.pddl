(define (problem newComplexProblem2) (:domain imprDomain)
(:objects
    train1 - sng
    train2 - icm
    train3 - slt
    ...
    train9 - virm
    train10 - virm
    v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 t0 t1 t2 t3 t4 t5 t6 t7 t8 t9 t10 t11 t12 t13 t14 t15  - trackpart
    track1 track2 track3  - LIFO
)
(:init
    (at train1 v1)
    (next v1 v2)
