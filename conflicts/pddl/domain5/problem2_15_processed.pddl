(define (problem problem2_15) (:domain domain5)
(:objects
...
(:init
   (trainParkingTrack train3 track1) 
   (trainParkingTrack train5 track2) 
   (trainParkingTrack train13 track2) 
   (trainParkingTrack train1 track3) 
   (trainParkingTrack train2 track3) 
   (trainParkingTrack train4 track3) 
   (trainParkingTrack train6 track3) 
   (trainParkingTrack train7 track3) 
   (trainParkingTrack train8 track4) 
   (trainParkingTrack train9 track4) 
   (trainParkingTrack train10 track4) 
   (trainParkingTrack train11 track4) 
   (trainParkingTrack train12 track4) 
   (trainParkingTrack train14 track4) 
   (trainParkingTrack train15 track4) 
    (station v1)
    (driver train1)
