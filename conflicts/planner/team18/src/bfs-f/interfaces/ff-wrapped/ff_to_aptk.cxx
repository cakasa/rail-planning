					...
					bool get_detailed_fluent_names )
{
	...
	{
		// std::cout << FF::get_ft_pred_name(i) << std::endl;
		strips_problem.set_fluent_pred_names(i, FF::get_ft_pred_name(i));
		std::vector<std::string> args;
		FF::get_ft_pred_arg_list(i, args);
		strips_problem.set_fluent_pred_args(i, args);
		// for (auto arg : args) {
		// 	std::cout << arg << std::endl;
		// }
		std::cout << FF::get_ft_pred_name(i) << std::endl;
		std::cout << strips_problem.fluent_pred_names(i) << std::endl;
