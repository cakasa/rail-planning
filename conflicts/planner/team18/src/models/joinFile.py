...
def writeFile(name, data, head):
	...
	for i in data:
		line = line + i
	print line
	entry = line + ",arvand, True\n"
	fd.write(entry)
	entry = line + ",lamar, True\n"
	fd.write(entry)
	entry = line + ",fd-autotune-1, True\n"
	fd.write(entry)
	entry = line + ",fd-autotune-2, True\n"
	fd.write(entry)
	entry = line + ",fdss-2, True\n"
	fd.write(entry)
	entry = line + ",lama-2008, True\n"
	fd.write(entry)
	entry = line + ",lama-2011, True\n"
	fd.write(entry)
	entry = line + ",lpg, True\n"
	fd.write(entry)
	entry = line + ",madagascar, True\n"
	fd.write(entry)
