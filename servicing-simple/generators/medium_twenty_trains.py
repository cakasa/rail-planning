...
trains = {
    ...
    'train16': ('slt', []),
    'train17': ('sng', []),
    'train18': ('icm', ['inspection']),
    'train19': ('virm', []),
    'train20': ('sng', []),
}
arrival_order = ['train1', 'train2', 'train3', 'train4', 'train5', 'train6', 'train7', 'train8', 'train9', 'train10', 'train11', 'train12', 'train13', 'train14', 'train15', 'train16', 'train17', 'train18', 'train19', 'train20']
departure_order = ['train15', 'train10', 'train13', 'train7', 'train5', 'train1', 'train12', 'train3', 'train9', 'train6', 'train8', 'train11', 'train2', 'train14', 'train4', 'train16', 'train17', 'train18', 'train19', 'train20']
